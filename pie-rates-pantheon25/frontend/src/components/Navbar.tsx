...
const Navbar = () => {
  ...
  return (
    <header className="bg-trackaro-bg/80 dark:bg-trackaro-bg/80 backdrop-blur-sm sticky top-0 z-50 w-full border-b border-trackaro-border dark:border-trackaro-border">
